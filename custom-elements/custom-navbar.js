            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link ${activeGuizero}" href="${pathPrefix}/activities/guizero-based/index.html">Guizero</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${activePygameZero}" href="${pathPrefix}/activities/pygame-zero-based/index.html">Pygame Zero</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${activeAdventurelib}" href="${pathPrefix}/activities/adventurelib-based/index.html">Adventurelib</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${activeP5}" href="${pathPrefix}/activities/p5-based/index.html">P5</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link ${activePythonLibraries}" href="${pathPrefix}/activities/python-libraries/index.html">Python libraries</a>
                        </li>
                    </ul>
                </div>
            </div>
